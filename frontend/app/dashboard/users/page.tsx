                                ...
                                <div>
                                    ...
                                    {isEditing ? (
                                        <select
                                            ...
                                            className="mt-1 block w-full text-sm rounded-lg border border-slate-200 bg-white focus:ring-blue-500 focus:border-blue-500"
                                        >
                                        ...
                                        <div>
                                            ...
                                            {isEditing ? (
                                                <input
                                                    ...
                                                    className="mt-1 block w-full text-sm rounded-lg border border-slate-200 bg-white"
                                                />
                                            ) : (
